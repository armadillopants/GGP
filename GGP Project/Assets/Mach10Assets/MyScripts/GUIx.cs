...
/*
 This script does not belong to Matthew Martin. It is a free GUI extension script off of the
 Unity community website. It is being used for re-scaling GUI textures based on screen width and height.
*/
...
public class GUIx
{
	...
	public static void DrawScaleTexture(Rect screenRect, Texture texture)
	{
		// sanity check
